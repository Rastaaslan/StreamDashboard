...
const commandTypes = new Set<Command['type']>(['mode.set', 'timer.start', 'timer.pause', 'timer.reset', 'timer.add', 'obs.scene', 'obs.mute', 'obs.volume', 'obs.stream', 'obs.record', 'obs.media.restart', 'checklist.toggle', 'checklist.reset']);
