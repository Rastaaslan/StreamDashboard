...
export function createTransport(getServer, getCredential) {
  ...
  return {
    ...
    updatePlanning: (id, value) => request(`/api/v1/planning/${encodeURIComponent(id)}`, { method: 'PUT', headers: authHeaders(), body: JSON.stringify(value) }),
    deletePlanning: (id, value = {}) => request(`/api/v1/planning/${encodeURIComponent(id)}`, { method: 'DELETE', headers: authHeaders(), body: JSON.stringify(value) }),
