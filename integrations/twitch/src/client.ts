...
export class TwitchClient {
  ...
  disconnect() { this.pending = undefined; this.credentials = { clientId: this.credentials.clientId, accessToken: '', refreshToken: '', broadcasterId: '', userName: '', displayName: '' }; this.error = null; }
